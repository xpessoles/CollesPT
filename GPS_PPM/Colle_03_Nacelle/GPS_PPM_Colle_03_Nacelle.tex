...
\includegraphics[height=.6cm]{images/gps_01}, \includegraphics[height=.6cm]{images/gps_02} et  \includegraphics[height=.6cm]{images/gps_03}.}

\subparagraph{}
\textit{Partant de cette spécification : \includegraphics[height=.6cm]{images/gps_03}, quelle serait l'influence d'un modificateur au maximum de matière sur l'intervalle de tolérance  ? sur l'élément de référence ? }
